...
class LearningAgent(Agent):
    ...
    def __init__(self, env, learning=False, epsilon=1.0, alpha=0.5):
        ...
        self.next_epsilon = self.epsilon
    ...
    def reset(self, trial, destination=None, testing=False):
        ...
        if testing:
            ...
            # self.next_epsilon =  self.alpha ** (trial / 100.0)
            #self.next_epsilon =  (math.cos(self.alpha * trial) + 1) / 2.0


            #self.next_epsilon = self.epsilon - 0.05
            self.next_epsilon =  math.cos(self.alpha * trial * 0.1)



            # self.next_epsilon =  math.e ** (-self.alpha * trial)
            # print '##########################'
            # print trial
            # print self.next_epsilon
    ...
    def createQ(self, state):
        ...
        if self.learning and not state in self.Q:
            stateAction = dict()
            self.Q[state] = stateAction
            for action in self.valid_actions:
                stateAction[action] = 0.0
    ...
    def learn(self, state, action, reward):
        ...
        if self.learning:
            ...
            stateAction[action] = (1 - self.alpha) * stateAction[action] + self.alpha * reward
